...
/**
 * Covers score calculation: simple A-F grade boundaries, mutation-pillar omission when Infection data is absent, file-metric inclusion, and
 * pillar-scoped composites.
 */
