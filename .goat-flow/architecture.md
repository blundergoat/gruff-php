...
| Waste | `waste.commented-out-code`, `waste.empty-class`, `waste.empty-method`, `waste.one-line-method`, `waste.unreachable-code`, `waste.unused-import`, `waste.unused-parameter` | AST-driven; one-line method detection targets trivial call wrappers |
| Naming | `naming.boolean-prefix`, `naming.class-file-mismatch`, `naming.confusing-name`, `naming.generic-method`, `naming.hungarian-notation`, `naming.identifier-quality`, `naming.short-variable`, `naming.test-naming-consistency` | Mix of identifier conventions, placeholder/generic identifier checks, and class/file alignment |
| Documentation | `docs.missing-public-phpdoc`, `docs.missing-param-tag`, `docs.missing-return-tag`, `docs.missing-throws-tag`, `docs.stale-param-tag`, `docs.useless-phpdoc`, `docs.todo-density`, `docs.missing-readme` | `docs.missing-public-phpdoc` requires local PHPDoc on every method declaration and reports errors. `docs.missing-readme` looks at `<projectRoot>/README.md` and is independent of the unit being analysed |
