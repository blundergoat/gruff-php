...
Last reviewed 2026-05-16. All claims map to a real file in `src/`, `tests/`, or top-level config; cross-check before broadening any of them.
...
| Naming | `naming.boolean-prefix`, `naming.class-file-mismatch`, `naming.confusing-name`, `naming.generic-method`, `naming.hungarian-notation`, `naming.identifier-quality`, `naming.parameter-type-name`, `naming.short-variable`, `naming.test-naming-consistency` | Mix of identifier conventions, placeholder/generic identifier checks, typed parameter names, and class/file alignment |
