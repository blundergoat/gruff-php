...
- **Lockstep contract extended.** `.goat-flow/learning-loop/footguns/schemas.md` and/or `.goat-flow/learning-loop/footguns/rules.md` gain `minimumSeverity:` and `schemaVersion:` as bump-sites that future config-schema changes must touch.
...
- Task package: `.goat-flow/plans/_archive/0.2.0/minimum-severity-overview.md`
- ADR-008 (single-threshold rubric severity): `.goat-flow/learning-loop/decisions/ADR-008-single-threshold-rubric-severity.md`
