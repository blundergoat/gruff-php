...
- Prior single-threshold severity decision (informs why the severity axis is not overloaded with scoring semantics): `.goat-flow/learning-loop/decisions/ADR-008-single-threshold-rubric-severity.md`.
- Task package: `.goat-flow/plans/_archive/0.2.0/M06-disabled-severity-visibility-tier.md`.
