...
**Status:** Accepted
**Date:** 2026-05-09
**Ticket/Context:** `.goat-flow/plans/_archive/0.1/M01-package-scaffold-and-quality-gates.md`

## Context

M01 needs real project commands before subsequent v0.1 milestones can rely on PHP tooling. The repository started as a scaffold with no `composer.json`, `src/`, `tests/`, or PHP runtime config, as recorded in `.goat-flow/learning-loop/footguns/setup.md` (search: `PHP-named scaffold has no PHP app surface yet`).
