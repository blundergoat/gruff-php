...
- M35 (tag completeness) fills in `@param`, `@throws`, and `@return` (where missing) using descriptions consistent with the one-line purpose statements landed by M33 and M34.
