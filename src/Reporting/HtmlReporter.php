...
final readonly class HtmlReporter
{
    ...
    private function distribution(AnalysisReport $report): string
    {
        ...
        return '<section class="chart-section"><div class="section-head">distribution <span class="aside">complexity and mutation</span></div>'
            . '<div class="chart-grid"><div class="chart-card"><div class="title">cyclomatic complexity · flagged methods</div>'
            . '<div class="histogram">' . $bars . '</div><div class="histogram-axis">' . $axis . '</div></div>'
            . '<div class="chart-card"><div class="title">mutation score · per file</div>'
            . $this->mutationList($report)
            . '</div></div></section>';
    }
    ...
    private function mutationList(AnalysisReport $report): string
    {
        if ($report->mutation === null) {
            return '<div class="empty">Mutation data unavailable. Supply --infection-report to include MSI.</div>';
        }
